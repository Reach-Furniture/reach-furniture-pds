        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex flex-wrap items-center justify-end gap-5 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              <img src={emailIcon} alt="Email icon for contacting REACH Furniture PDS" className="w-5 sm:w-6 icon-a03359" />
            ...
            >
              <img src={whatsappIcon} alt="Whatsapp icon for REACH Furniture PDS" className="w-5 sm:w-6 icon-a03359" />
            ...
            <a
              ...
              className="flex items-center gap-2"
            >
              <img src={contactIcon} alt="Contact form icon for REACH Furniture PDS" className="w-5 sm:w-6 icon-a03359" />
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <Link to="/" className="text-3xl sm:text-4xl font-bold">
              ...
              <span className="text-black"> Furniture PDS</span>
            </Link>
